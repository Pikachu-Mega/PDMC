...
class SSBA(BadNet):
    ...
    def process_args(self, args):
        ...
        if ('attack_train_replace_imgs_path' not in args.__dict__) or (args.attack_train_replace_imgs_path is None):
            args.attack_train_replace_imgs_path = f"/mnt/BackdoorBench-main/resource/ssba/{args.dataset}_ssba_train_b1.npy"
            logging.info(
        ...
        if ('attack_test_replace_imgs_path' not in args.__dict__) or (args.attack_test_replace_imgs_path is None):
            args.attack_test_replace_imgs_path = f"/mnt/BackdoorBench-main/resource/ssba/{args.dataset}_ssba_test_b1.npy"
            logging.info(
